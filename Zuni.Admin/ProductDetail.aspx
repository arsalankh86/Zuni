<%@ Page Title="" Language="C#" MasterPageFile="~/Zuni.Master" AutoEventWireup="true" CodeBehind="ProductDetail.aspx.cs" Inherits="Zuni.Admin.ProductDetail" %>
        ...
        <RowStyle BackColor="#F7F7DE" />
            <AlternatingRowStyle BackColor="White" />
                ...
                <asp:BoundField HeaderText="Image Path" DataField="ImageFilenameOverride" />
                     ...
                     <asp:TemplateField>
                         <ItemTemplate>
                             <asp:Image ImageUrl="ImageFilenameOverride" runat="server" />
                         </ItemTemplate>
                     </asp:TemplateField>

                     <asp:ImageField DataImageUrlFormatString="ImageFilenameOverride" HeaderText="Image"></asp:ImageField>
                 </Columns>
